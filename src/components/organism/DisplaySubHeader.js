  ...
  return (
    <span className=''>
      ...
      <div className='flex flex-col items-center justify-center h-full'>
        ...
        <CustomButton styleToAdd="text-white bg-black px-6 py-3 mt-2 rounded-3xl bulb__hide" data-testid="scroll" onClickMethod={onClickScroll}>Start Reading</CustomButton>
      </div>
